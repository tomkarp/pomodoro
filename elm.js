...
var $author$project$Main$WorkTime = {$: 'WorkTime'};
...
var $author$project$Main$PauseTimer = {$: 'PauseTimer'};
		...
		switch (msg.$) {
			...
			case 'ResetTimer':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{currentTime: (model.workTime * 60) * 1000, isRunning: false, phase: $author$project$Main$WorkTime}),
					$elm$core$Platform$Cmd$none);
			case 'TogglePhase':
				if (!model.isRunning) {
					var _v1 = function () {
						var _v2 = model.phase;
						if (_v2.$ === 'WorkTime') {
							return _Utils_Tuple2($author$project$Main$BreakTime, (model.breakTime * 60) * 1000);
						} else {
							return _Utils_Tuple2($author$project$Main$WorkTime, (model.workTime * 60) * 1000);
						}
					}();
					var newPhase = _v1.a;
					var newTime = _v1.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{currentTime: newTime, phase: newPhase}),
						$elm$core$Platform$Cmd$none);
				} else {
			...
			case 'Tick':
				if (model.isRunning) {
					var newTime = A2($elm$core$Basics$max, 0, model.currentTime - 1000);
					if (!newTime) {
						var _v3 = model.phase;
						if (_v3.$ === 'WorkTime') {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{currentTime: (model.breakTime * 60) * 1000, isRunning: false, phase: $author$project$Main$BreakTime}),
...
var $author$project$Main$SetBreakTime = function (a) {
	return {$: 'SetBreakTime', a: a};
};
var $author$project$Main$SetWorkTime = function (a) {
...
var $author$project$Main$formatTime = function (milliseconds) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Pomodoro Timer')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('setting-group')
							]),
						_List_fromArray(
							[
								A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('timer-display')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('timer-circle')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onClick($author$project$Main$TogglePhase)
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('control-button'),
										$elm$html$Html$Events$onClick(
										model.isRunning ? $author$project$Main$PauseTimer : $author$project$Main$StartTimer)
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										model.isRunning ? 'Pause' : 'Start')
									])),
								A2(
								$elm$html$Html$button,
								_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('keyboard-hints')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Leertaste = Start/Pause, R = Reset')
							]))
					]))
			]));
};
